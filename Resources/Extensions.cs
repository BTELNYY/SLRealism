...
namespace SLRealism
{
    public static class Extensions
    {
        ...
        {
            var files = Directory.GetFiles(SLRealism.instance.AudioPath);
        ...
        {
            if (!Directory.Exists(SLRealism.instance.AudioPath))
            {
                Directory.CreateDirectory(SLRealism.instance.AudioPath);
            }
        }
    }
}